// Package peoplesvc owns read operations against TeamDynamix's /api/people
// endpoints. It composes profile and credentials stores with the tdx.Client
// and exposes typed domain-shaped methods to CLI and MCP callers.
package peoplesvc
